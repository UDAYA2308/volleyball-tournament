...
async def watch_match():
    ...
    async with websockets.connect(uri) as ws:
        ...
        while True:
            ...
            print(
                f"  Match: {match_data.get('team_a_name')} vs {match_data.get('team_b_name')}"
            )
            print(
    ...
    async with websockets.connect(uri) as ws:
        ...
        while True:
            ...
            for match in data.get("data", []):
                print(
                    f"  {match.get('team_a_name')} {match.get('team_a_score')}-{match.get('team_b_score')} {match.get('team_b_name')}"
                )
